...
const kFavoriteColor = Color(0xFFEB1555);
const kBgGreyOverlayColor = Color(0X66EEEEEE);

const kListTitleTextStyle = TextStyle(fontSize: 14.0, fontWeight: FontWeight.bold);
